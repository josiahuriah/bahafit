...
// Official Google "G" mark, per the Google branding guidelines for sign-in buttons.
...
function SignUpForm() {
  ...
  // Google sign-up and sign-in are the same OAuth flow — the `signIn` callback
  // in lib/auth.ts creates the account on first authentication.
