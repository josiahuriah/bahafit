          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <aside className="space-y-4">
              ...
              <div className="bg-[#0dd5b5]/5 border border-[#0dd5b5]/20 rounded-xl p-4">
                <p className="text-sm font-semibold text-gray-900 mb-1">Train with an Apple Watch?</p>
                <p className="text-xs text-gray-600 mb-2">
                  Auto-post your workouts to Bahafit with an iOS Shortcut, or upload GPX files from any device.
                </p>
                <Link href="/community/log?tab=connect" className="text-xs font-semibold text-[#0dd5b5] hover:underline">
                  Set it up →
                </Link>
              </div>
            </aside>
