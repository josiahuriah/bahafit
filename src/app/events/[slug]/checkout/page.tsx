  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        {/* Merchant Identity Bar — RBC #1, #12 */}
        <div className="bg-[#0dd5b5]/10 border-b border-[#0dd5b5]/20">
          <div className="max-w-5xl mx-auto px-4 py-2 flex flex-wrap items-center justify-between gap-2 text-xs text-gray-600">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl shadow-sm p-5 sm:p-6 lg:sticky lg:top-24">
                ...
                {/* Price Breakdown — RBC #3 (currency) */}
                <div className="mb-5 pb-5 border-b">
                  <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">
                    Payment Summary
                  </h2>
                ...
                <p className="text-xs text-gray-400 text-center mt-2">
                  A confirmation email will be sent to you. Please retain it as your record of this transaction.
                </p>
