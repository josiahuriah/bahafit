        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Explore everything fitness has to offer
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-5 gap-12">
            {[
              { name: 'Race', image: '/images/race.jpg' },
              { name: 'Clubs', image: '/images/clubs.jpg' },
              { name: 'Studios', image: '/images/studios.jpg' },
              { name: 'Gyms', image: '/images/gyms.jpg' },
              { name: 'Classes', image: '/images/classes.jpg' },
              { name: 'Activities', image: '/images/activities.jpg' },
              { name: 'Health Fairs', image: '/images/health-fairs.jpg' },
              { name: 'Fitness Guide', image: '/images/fitness-guide.jpg' },
              ...
              <Link
                ...
                className="group overflow-hidden  hover:shadow-2xl transition-all duration-300 hover:scale-105 bg-white"
              >
                ...
                <div className="p-4">
                  <h3 className="text-gray-900 text-lg md:text-xl font-bold text-center">
                    {item.name}
                  </h3>
                </div>
              </Link>
