      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 md:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" aria-label="Instagram" className="text-white/30 hover:text-[#0dd5b5] transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" aria-label="Twitter / X" className="text-white/30 hover:text-[#0dd5b5] transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-white/45 hover:text-white transition-colors" style={{ fontFamily: 'var(--font-body)' }}>
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-white/8 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/30" style={{ fontFamily: 'var(--font-body)' }}>
            © {new Date().getFullYear()} Bahafit. All rights reserved.
          </p>
          <div className="flex gap-6">
            {[
              ...
              <Link key={link.href} href={link.href} className="text-xs text-white/30 hover:text-white/60 transition-colors" style={{ fontFamily: 'var(--font-body)' }}>
                {link.label}
              </Link>
            ))}
          </div>
