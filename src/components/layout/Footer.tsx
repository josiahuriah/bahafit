      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/list-your-business" className="text-sm hover:text-white transition-colors">
                  List Your Business
                </Link>
              </li>
              <li>
                <Link href="/create-event" className="text-sm hover:text-white transition-colors">
                  Create an Event
                </Link>
              </li>
              <li>
